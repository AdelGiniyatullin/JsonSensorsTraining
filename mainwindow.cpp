    ...
    for (int i=0; i<sensorsData.count(); i++)
                {
                  if ((QString::number(sensorsData[i].sensorNumber)) != ui->listWidget->currentItem()->text()){
                      ...
                      ui->Ft0->setText("");
                      ui->Fp0->setText("");
                      sensorsData[sensorsData.count()-1].sensorNumber = ui->listWidget->currentItem()->text().toDouble();
    ...
    for (int i=0; i<sensorsData.count()-1; i++)
        {
...

            {
                ...
                sensorsData[i] = tmpSensor2;
            }

            else if ((QString::number(sensorsData[sensorsData.count()-1].sensorNumber)) == ui->listWidget->currentItem()->text())
            {
                 Sensor tmpSensor2;
                tmpSensor2.sensorNumber =  ui->SensorNumber->text().toDouble();
                tmpSensor2.name = ui->Name->text();
                ...
                tmpSensor2.Fp0 = ui->Fp0->text().toInt();
                tmpSensor2.Ft0 = ui->Ft0->text().toInt();
                sensorsData[sensorsData.count()-1] = tmpSensor2;
            }
    }
